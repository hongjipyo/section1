...
class NcafeWrite:
    ...
    def writecheck(self):
        self.driver.get('http://webhacking.kr/')
        self.driver.find_element_by_name('id').send_keys('magic9569')
        ...
        self.driver.get('http://webhacking.kr/index.php')
        self.driver.implicitly_wait(30)
        self.driver.find_element_by_id('chat').send_keys('a')
        self.driver.find_element_by_xpath('/html/body/table/tbody/tr[2]/td/input[3]').click()
        time.sleep(3)
